...
function Modal(props) {
	//console.log(props.product.photo_id)
	return (
		<div 
			...
			>
				<div onClick={(e)=>{e.stopPropagation()}} className={styles.cardModal}>
					...
					<div className={styles.cardModal__about}>
						<img src={props.product.photo_id} alt="img" />
						<div className={styles.cardModal__aboutDesc}>
							<div>
								<h6>Описание</h6><span>{props.product.weight}г</span>
							</div>
					...
					<div className={styles.info}>
						<div className={styles.infoMobTitle}>
							...
							<div className={styles.info__titleWrap}>
								<h3 className={styles.info__title}>{props.product.name}</h3>
								<span className={styles.info__weight}>{props.product.weight}г</span> 
								<span className={styles.card__price}>{props.product.price}&#8381;</span>
							</div>
						</div>
